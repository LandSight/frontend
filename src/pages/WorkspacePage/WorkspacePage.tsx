...
import { useWorkspaceUrlSync } from '#/features/workspace/hooks';

const POLL_INTERVAL_MS = 3000;

export const WorkspacePage = reatomComponent(() => {
  useWorkspaceUrlSync();
  ...
  return (
    <Box sx={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
      ...
      <AnalysisStartDialog />
      <CreateParcelDialog open={isCreateParcelDialogOpen} onClose={handleCloseCreateParcelDialog} />
    </Box>
  );
}, 'WorkspacePage');
